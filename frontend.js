...
var List = /** @class */ (function () {
    ...
    List.prototype.setListName = function (listName) {
...
var Task = /** @class */ (function () {
    ...
    Task.prototype.getTaskSelected = function () {
        return this.isSelected;
    };
    Task.prototype.setTaskSelected = function (isSelected) {
        this.isSelected = isSelected;
    };
    Task.prototype.getTaskStarred = function () {
        return this.isStarred;
    };
    Task.prototype.setTaskStarred = function (isStarred) {
    ...
    Task.prototype.getHint = function () {
        return this.hint;
    };
    Task.prototype.setHint = function (hint) {
        this.hint = hint;
    };
    return Task;
}());
...
function deleteList(event) {
    ...
    for (var index = 0; index < itemLists.length; index++) {
...
function displaySelectedList(event) {
    ...
    if (listItem.tasks.length > 0) {
        for (var index = 0; index < listItem.tasks.length; index++) {
